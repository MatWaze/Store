        ...
        public async void Can_Get_Item()
        {
            ...
            using (var context = new DataContext(options))
            {
                ...
                EbayController ebay = new EbayController(mockOauth.Object,
                    null, mockClient.Object, repo, mockUserManager.Object);

                Product? result = ((await ebay.GetItem("v1|405225274855|0") as ViewResult)?
                ...
                Assert.Equal(result.Name, "Lancia Thema Ferrari F105L Engine");
                Assert.NotEqual(result.Description, "New");
                Assert.Equal(result.Description, "Used");

                Assert.NotEqual(result2.Name, "P2");
                Assert.False(result2.EbayProductId != "1");
            }
        }
